...
//            data = data.trim();
//            jsoupTwo("http://hs.bianmachaxun.com/query/code.php?word=" + (data.length() < 4 ? "0" + data : data));
//        }
...
//                System.out.println("************"+data.text());
    ...
    public static Map<String,Object> jsoupThree(String url) {
        ...
        Map<String,Object> map = Maps.newHashMap("地址",url);
...
//            System.out.println("********"+tb.getAllElements());
            ...
            String key=null;
            Elements nei = tb.select("td");
            for (int i =0;i<nei.size();i++){
                Element ts = nei.get(i);
    ...
    public static List<String> jsoupTwo(String url) {
